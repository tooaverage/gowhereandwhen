...
home=publicHTML(home).replace(/<title>[^<]*<\/title>/,'<title>gowhereandwhen.com | Best time to visit anywhere, by month</title>')
 .replaceAll('./assets/logo.svg','./storybook/assets/logo.svg').replaceAll('./game.css?v=storybook18','./storybook/game.css?v=storybook18')
 .replaceAll('./app.js?v=storybook18','./storybook/app.js?v=storybook18').replaceAll('../play/','./play/')
...
for(const entry of fs.readdirSync(path.join(root,'storybook/country'),{withFileTypes:true})){
 ...
 .replaceAll('../../game.css?v=storybook18','../../storybook/game.css?v=storybook18').replaceAll('../../app.js?v=storybook18','../../storybook/app.js?v=storybook18')
