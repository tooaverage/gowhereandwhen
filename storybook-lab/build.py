...
for name in ['index.html','app.js','map.js','game.css','world-details.js','traffic.js','reveal.js','data.json']:
...
for source in sorted((r.parent/'play/country').glob('*/index.html')):
 ...
 page=page.replace('../../game.css?v=world7final','../../game.css?v=storybook29').replace('../../app.js?v=world7final','../../app.js?v=storybook29')
 ...
 if slug in ['japan','canada']:
  poster=f'../../assets/{slug}-hero.webp?v=storybook29'
