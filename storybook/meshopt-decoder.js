...
// Decode geometry away from input handling when workers are available.
if(typeof Worker!=="undefined"){try{MeshoptDecoder.useWorkers(2);}catch{/* Synchronous decoder remains available. */}}
