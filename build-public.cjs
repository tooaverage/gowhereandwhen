...
home=publicHTML(home).replace(/<title>[^<]*<\/title>/,'<title>gowhereandwhen.com | Best time to visit anywhere, by month</title>')
 .replaceAll('./assets/logo.svg','./storybook/assets/logo.svg').replaceAll('./game.css?v=storybook11','./storybook/game.css?v=storybook11')
 .replaceAll('./app.js?v=storybook11','./storybook/app.js?v=storybook11').replaceAll('../play/','./play/')
...
for(const entry of fs.readdirSync(path.join(root,'storybook/country'),{withFileTypes:true})){
 ...
 .replaceAll('../../game.css?v=storybook11','../../storybook/game.css?v=storybook11').replaceAll('../../app.js?v=storybook11','../../storybook/app.js?v=storybook11')
