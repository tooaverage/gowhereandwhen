...
def scripts(prefix,slug=''):
 return f'''<script>window.GAME_META={{root:{json.dumps(prefix)},slug:{json.dumps(slug)}}};</script><script src="{prefix}vendor/delaunator.min.js"></script><script type="module" src="{prefix}app.js"></script>'''
...
for name in ['game.css','app.js','map.js','data.json']:
